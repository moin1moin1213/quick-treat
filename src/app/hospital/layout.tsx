...
const navItems = [
  ...
  { name: 'Doctor Management', href: '/hospital/doctors', icon: '👨‍⚕️' },
  { name: 'Facility Management', href: '/hospital/facility', icon: '🏥' },
  { name: 'Bed Management', href: '/hospital/beds', icon: '🛏️' },
  { name: 'Reports', href: '/hospital/reports', icon: '📈' },
  { name: 'My Wallet', href: '/hospital/wallet', icon: '💰' },
  { name: 'Settings', href: '/hospital/settings', icon: '⚙️' },
]
        ...
        <div className="flex justify-between items-center px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-text-grey">Hospital Portal</p>
            </div>
          </div>
          <button 
